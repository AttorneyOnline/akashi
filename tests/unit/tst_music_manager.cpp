...
void MusicListManager::addCustomSong()
{
    ...
    }
    {
        ...
        m_music_manager->toggleCustomMusicEnabled(0);
...
void MusicListManager::removeCustomMusic()
{
    {
    ...
    }
    {
        ...
        bool l_success = m_music_manager->removeCustomMusic("==Music==", 0);
        QCOMPARE(l_success, false);
        QCOMPARE(m_music_manager->musiclist(0).size(), 7);
    }
    {
        // Correct category name, wrong format.
        bool l_success = m_music_manager->removeCustomMusic("Music2", 0);
        QCOMPARE(l_success, false);
        QCOMPARE(m_music_manager->musiclist(0).size(), 7);
    }
    {
    ...
    }
    {
        ...
        bool l_success = m_music_manager->removeCustomMusic("mysong2.opus", 0);
        QCOMPARE(l_success, true);
        QCOMPARE(m_music_manager->musiclist(0).size(), 5);
    }
}
