...
void tst_ArupBroadcaster::buildPlayerCount()
{
    ...
    const akashi::Packet p = b.buildFloorArup(akashi::ArupBroadcaster::Type::PlayerCount, 0);
...
void tst_ArupBroadcaster::buildStatus()
{
    ...
    const akashi::Packet p = b.buildFloorArup(akashi::ArupBroadcaster::Type::Status, 0);
...
void tst_ArupBroadcaster::buildCmFree()
{
    ...
    const akashi::Packet p = b.buildFloorArup(akashi::ArupBroadcaster::Type::Cm, 0);
...
void tst_ArupBroadcaster::buildLock()
{
    ...
    const akashi::Packet p = b.buildFloorArup(akashi::ArupBroadcaster::Type::Lock, 0);
