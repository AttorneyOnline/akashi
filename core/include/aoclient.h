  ...
  private:
    ...
    */
    ...
    const QMap<QString, CommandInfo> commands {
        {"login",              {ACLFlags.value(ConfigManager::aclPermission("login")),              0, &AOClient::cmdLogin}},
        {"getareas",           {ACLFlags.value(ConfigManager::aclPermission("getareas")),           0, &AOClient::cmdGetAreas}},
        {"getarea",            {ACLFlags.value(ConfigManager::aclPermission("getarea")),            0, &AOClient::cmdGetArea}},
        {"ban",                {ACLFlags.value(ConfigManager::aclPermission("ban")),                3, &AOClient::cmdBan}},
        {"kick",               {ACLFlags.value(ConfigManager::aclPermission("kick")),               2, &AOClient::cmdKick}},
        {"changeauth",         {ACLFlags.value(ConfigManager::aclPermission("changeauth")),         0, &AOClient::cmdChangeAuth}},
        {"rootpass",           {ACLFlags.value(ConfigManager::aclPermission("rootpass")),           1, &AOClient::cmdSetRootPass}},
        {"background",         {ACLFlags.value(ConfigManager::aclPermission("background")),         1, &AOClient::cmdSetBackground}},
        {"bg",                 {ACLFlags.value(ConfigManager::aclPermission("background")),         1, &AOClient::cmdSetBackground}},
        {"bglock",             {ACLFlags.value(ConfigManager::aclPermission("bglock")),             0, &AOClient::cmdBgLock}},
        {"bgunlock",           {ACLFlags.value(ConfigManager::aclPermission("bgunlock")),           0, &AOClient::cmdBgUnlock}},
        {"adduser",            {ACLFlags.value(ConfigManager::aclPermission("adduser")),            2, &AOClient::cmdAddUser}},
        {"listperms",          {ACLFlags.value(ConfigManager::aclPermission("listperms")),          0, &AOClient::cmdListPerms}},
        {"addperm",            {ACLFlags.value(ConfigManager::aclPermission("addperm")),            2, &AOClient::cmdAddPerms}},
        {"removeperm",         {ACLFlags.value(ConfigManager::aclPermission("removeperm")),         2, &AOClient::cmdRemovePerms}},
        {"listusers",          {ACLFlags.value(ConfigManager::aclPermission("listusers")),          0, &AOClient::cmdListUsers}},
        {"logout",             {ACLFlags.value(ConfigManager::aclPermission("logout")),             0, &AOClient::cmdLogout}},
        {"pos",                {ACLFlags.value(ConfigManager::aclPermission("pos")),                1, &AOClient::cmdPos}},
        {"g",                  {ACLFlags.value(ConfigManager::aclPermission("g")),                  1, &AOClient::cmdG}},
        {"need",               {ACLFlags.value(ConfigManager::aclPermission("need")),               1, &AOClient::cmdNeed}},
        {"coinflip",           {ACLFlags.value(ConfigManager::aclPermission("coinflip")),           0, &AOClient::cmdFlip}},
        {"roll",               {ACLFlags.value(ConfigManager::aclPermission("roll")),               0, &AOClient::cmdRoll}},
        {"rollp",              {ACLFlags.value(ConfigManager::aclPermission("rollp")),              0, &AOClient::cmdRollP}},
        {"doc",                {ACLFlags.value(ConfigManager::aclPermission("doc")),                0, &AOClient::cmdDoc}},
        {"cleardoc",           {ACLFlags.value(ConfigManager::aclPermission("cleardoc")),           0, &AOClient::cmdClearDoc}},
        {"cm",                 {ACLFlags.value(ConfigManager::aclPermission("cm")),                 0, &AOClient::cmdCM}},
        {"uncm",               {ACLFlags.value(ConfigManager::aclPermission("uncm")),               0, &AOClient::cmdUnCM}},
        {"invite",             {ACLFlags.value(ConfigManager::aclPermission("invite")),             1, &AOClient::cmdInvite}},
        {"uninvite",           {ACLFlags.value(ConfigManager::aclPermission("uninvite")),           1, &AOClient::cmdUnInvite}},
        {"lock",               {ACLFlags.value(ConfigManager::aclPermission("lock")),               0, &AOClient::cmdLock}},
        {"area_lock",          {ACLFlags.value(ConfigManager::aclPermission("area_lock")),          0, &AOClient::cmdLock}},
        {"spectatable",        {ACLFlags.value(ConfigManager::aclPermission("spectatable")),        0, &AOClient::cmdSpectatable}},
        {"area_spectate",      {ACLFlags.value(ConfigManager::aclPermission("area_spectate")),      0, &AOClient::cmdSpectatable}},
        {"unlock",             {ACLFlags.value(ConfigManager::aclPermission("unlock")),             0, &AOClient::cmdUnLock}},
        {"area_unlock",        {ACLFlags.value(ConfigManager::aclPermission("area_unlock")),        0, &AOClient::cmdUnLock}},
        {"timer",              {ACLFlags.value(ConfigManager::aclPermission("timer")),              0, &AOClient::cmdTimer}},
        {"area",               {ACLFlags.value(ConfigManager::aclPermission("area")),               1, &AOClient::cmdArea}},
        {"play",               {ACLFlags.value(ConfigManager::aclPermission("play")),               1, &AOClient::cmdPlay}},
        {"areakick",           {ACLFlags.value(ConfigManager::aclPermission("areakick")),           1, &AOClient::cmdAreaKick}},
        {"area_kick",          {ACLFlags.value(ConfigManager::aclPermission("area_kick")),          1, &AOClient::cmdAreaKick}},
        {"randomchar",         {ACLFlags.value(ConfigManager::aclPermission("randomchar")),         0, &AOClient::cmdRandomChar}},
        {"switch",             {ACLFlags.value(ConfigManager::aclPermission("switch")),             1, &AOClient::cmdSwitch}},
        {"toggleglobal",       {ACLFlags.value(ConfigManager::aclPermission("toggleglobal")),       0, &AOClient::cmdToggleGlobal}},
        {"mods",               {ACLFlags.value(ConfigManager::aclPermission("mods")),               0, &AOClient::cmdMods}},
        {"commands",           {ACLFlags.value(ConfigManager::aclPermission("commands")),           0, &AOClient::cmdCommands}},
        {"status",             {ACLFlags.value(ConfigManager::aclPermission("status")),             1, &AOClient::cmdStatus}},
        {"forcepos",           {ACLFlags.value(ConfigManager::aclPermission("forcepos")),           2, &AOClient::cmdForcePos}},
        {"currentmusic",       {ACLFlags.value(ConfigManager::aclPermission("currentmusic")),       0, &AOClient::cmdCurrentMusic}},
        {"pm",                 {ACLFlags.value(ConfigManager::aclPermission("pm")),                 2, &AOClient::cmdPM}},
        {"evidence_mod",       {ACLFlags.value(ConfigManager::aclPermission("evidence_mod")),       1, &AOClient::cmdEvidenceMod}},
        {"motd",               {ACLFlags.value(ConfigManager::aclPermission("motd")),               0, &AOClient::cmdMOTD}},
        {"announce",           {ACLFlags.value(ConfigManager::aclPermission("announce")),           1, &AOClient::cmdAnnounce}},
        {"m",                  {ACLFlags.value(ConfigManager::aclPermission("m")),                  1, &AOClient::cmdM}},
        {"gm",                 {ACLFlags.value(ConfigManager::aclPermission("gm")),                 1, &AOClient::cmdGM}},
        {"mute",               {ACLFlags.value(ConfigManager::aclPermission("mute")),               1, &AOClient::cmdMute}},
        {"unmute",             {ACLFlags.value(ConfigManager::aclPermission("unmute")),             1, &AOClient::cmdUnMute}},
        {"bans",               {ACLFlags.value(ConfigManager::aclPermission("bans")),               0, &AOClient::cmdBans}},
        {"unban",              {ACLFlags.value(ConfigManager::aclPermission("unban")),              1, &AOClient::cmdUnBan}},
        {"removeuser",         {ACLFlags.value(ConfigManager::aclPermission("removeuser")),         1, &AOClient::cmdRemoveUser}},
        {"subtheme",           {ACLFlags.value(ConfigManager::aclPermission("subtheme")),           1, &AOClient::cmdSubTheme}},
        {"about",              {ACLFlags.value(ConfigManager::aclPermission("about")),              0, &AOClient::cmdAbout}},
        {"evidence_swap",      {ACLFlags.value(ConfigManager::aclPermission("evidence_swap")),      2, &AOClient::cmdEvidence_Swap}},
        {"notecard",           {ACLFlags.value(ConfigManager::aclPermission("notecard")),           1, &AOClient::cmdNoteCard}},
        {"notecardreveal",     {ACLFlags.value(ConfigManager::aclPermission("notecardreveal")),     0, &AOClient::cmdNoteCardReveal}},
        {"notecard_reveal",    {ACLFlags.value(ConfigManager::aclPermission("notecardreveal")),     0, &AOClient::cmdNoteCardReveal}},
        {"notecardclear",      {ACLFlags.value(ConfigManager::aclPermission("notecardclear")),      0, &AOClient::cmdNoteCardClear}},
        {"notecard_clear",     {ACLFlags.value(ConfigManager::aclPermission("notecard_clear")),     0, &AOClient::cmdNoteCardClear}},
        {"8ball",              {ACLFlags.value(ConfigManager::aclPermission("8ball")),              1, &AOClient::cmd8Ball}},
        {"lm",                 {ACLFlags.value(ConfigManager::aclPermission("lm")),                 1, &AOClient::cmdLM}},
        {"judgelog",           {ACLFlags.value(ConfigManager::aclPermission("judgelog")),           0, &AOClient::cmdJudgeLog}},
        {"allowblankposting",  {ACLFlags.value(ConfigManager::aclPermission("allowblankposting")),  0, &AOClient::cmdAllowBlankposting}},
        {"allow_blankposting", {ACLFlags.value(ConfigManager::aclPermission("allowblankposting")),  0, &AOClient::cmdAllowBlankposting}},
        {"gimp",               {ACLFlags.value(ConfigManager::aclPermission("gimp")),               1, &AOClient::cmdGimp}},
        {"ungimp",             {ACLFlags.value(ConfigManager::aclPermission("ungimp")),             1, &AOClient::cmdUnGimp}},
        {"baninfo",            {ACLFlags.value(ConfigManager::aclPermission("baninfo")),            1, &AOClient::cmdBanInfo}},
        {"testify",            {ACLFlags.value(ConfigManager::aclPermission("testify")),            0, &AOClient::cmdTestify}},
        {"testimony",          {ACLFlags.value(ConfigManager::aclPermission("testimony")),          0, &AOClient::cmdTestimony}},
        {"examine",            {ACLFlags.value(ConfigManager::aclPermission("examine")),            0, &AOClient::cmdExamine}},
        {"pause",              {ACLFlags.value(ConfigManager::aclPermission("pause")),              0, &AOClient::cmdPauseTestimony}},
        {"delete",             {ACLFlags.value(ConfigManager::aclPermission("delete")),             0, &AOClient::cmdDeleteStatement}},
        {"update",             {ACLFlags.value(ConfigManager::aclPermission("update")),             0, &AOClient::cmdUpdateStatement}},
        {"add",                {ACLFlags.value(ConfigManager::aclPermission("add")),                0, &AOClient::cmdAddStatement}},
        {"reload",             {ACLFlags.value(ConfigManager::aclPermission("reload")),             0, &AOClient::cmdReload}},
        {"disemvowel",         {ACLFlags.value(ConfigManager::aclPermission("disemvowel")),         1, &AOClient::cmdDisemvowel}},
        {"undisemvowel",       {ACLFlags.value(ConfigManager::aclPermission("undisemvowel")),       1, &AOClient::cmdUnDisemvowel}},
        {"shake",              {ACLFlags.value(ConfigManager::aclPermission("shake")),              1, &AOClient::cmdShake}},
        {"unshake",            {ACLFlags.value(ConfigManager::aclPermission("unshake")),            1, &AOClient::cmdUnShake}},
        {"forceimmediate",     {ACLFlags.value(ConfigManager::aclPermission("forceimmediate")),     0, &AOClient::cmdForceImmediate}},
        {"force_noint_pres",   {ACLFlags.value(ConfigManager::aclPermission("forceimmediate")),     0, &AOClient::cmdForceImmediate}},
        {"allowiniswap",       {ACLFlags.value(ConfigManager::aclPermission("allowiniswap")),       0, &AOClient::cmdAllowIniswap}},
        {"allow_iniswap",      {ACLFlags.value(ConfigManager::aclPermission("allowiniswap")),       0, &AOClient::cmdAllowIniswap}},
        {"afk",                {ACLFlags.value(ConfigManager::aclPermission("afk")),                0, &AOClient::cmdAfk}},
        {"savetestimony",      {ACLFlags.value(ConfigManager::aclPermission("savetestimony")),      1, &AOClient::cmdSaveTestimony}},
        {"loadtestimony",      {ACLFlags.value(ConfigManager::aclPermission("loadtestimony")),      1, &AOClient::cmdLoadTestimony}},
        {"permitsaving",       {ACLFlags.value(ConfigManager::aclPermission("permitsaving")),       1, &AOClient::cmdPermitSaving}},
        {"mutepm",             {ACLFlags.value(ConfigManager::aclPermission("mutepm")),             0, &AOClient::cmdMutePM}},
        {"toggleadverts",      {ACLFlags.value(ConfigManager::aclPermission("toggleadverts")),      0, &AOClient::cmdToggleAdverts}},
        {"oocmute",            {ACLFlags.value(ConfigManager::aclPermission("oocmute")),            1, &AOClient::cmdOocMute}},
        {"ooc_mute",           {ACLFlags.value(ConfigManager::aclPermission("oocmute")),            1, &AOClient::cmdOocMute}},
        {"oocunmute",          {ACLFlags.value(ConfigManager::aclPermission("oocunmute")),          1, &AOClient::cmdOocUnMute}},
        {"ooc_unmute",         {ACLFlags.value(ConfigManager::aclPermission("oocunmute")),          1, &AOClient::cmdOocUnMute}},
        {"blockwtce",          {ACLFlags.value(ConfigManager::aclPermission("blockwtce")),          1, &AOClient::cmdBlockWtce}},
        {"block_wtce",         {ACLFlags.value(ConfigManager::aclPermission("blockwtce")),          1, &AOClient::cmdBlockWtce}},
        {"unblockwtce",        {ACLFlags.value(ConfigManager::aclPermission("unblockwtce")),        1, &AOClient::cmdUnBlockWtce}},
        {"unblock_wtce",       {ACLFlags.value(ConfigManager::aclPermission("unblockwtce")),        1, &AOClient::cmdUnBlockWtce}},
        {"blockdj",            {ACLFlags.value(ConfigManager::aclPermission("blockdj")),            1, &AOClient::cmdBlockDj}},
        {"block_dj",           {ACLFlags.value(ConfigManager::aclPermission("blockdj")),            1, &AOClient::cmdBlockDj}},
        {"unblockdj",          {ACLFlags.value(ConfigManager::aclPermission("unblockdj")),          1, &AOClient::cmdUnBlockDj}},
        {"unblock_dj",         {ACLFlags.value(ConfigManager::aclPermission("unblockdj")),          1, &AOClient::cmdUnBlockDj}},
        {"charcurse",          {ACLFlags.value(ConfigManager::aclPermission("charcurse")),          1, &AOClient::cmdCharCurse}},
        {"uncharcurse",        {ACLFlags.value(ConfigManager::aclPermission("uncharcurse")),        1, &AOClient::cmdUnCharCurse}},
        {"charselect",         {ACLFlags.value(ConfigManager::aclPermission("charselect")),         0, &AOClient::cmdCharSelect}},
        {"togglemusic",        {ACLFlags.value(ConfigManager::aclPermission("togglemusic")),        0, &AOClient::cmdToggleMusic}},
        {"a",                  {ACLFlags.value(ConfigManager::aclPermission("a")),                  2, &AOClient::cmdA}},
        {"s",                  {ACLFlags.value(ConfigManager::aclPermission("s")),                  0, &AOClient::cmdS}},
        {"kickuid",            {ACLFlags.value(ConfigManager::aclPermission("kickuid")),            2, &AOClient::cmdKickUid}},
        {"kick_uid",           {ACLFlags.value(ConfigManager::aclPermission("kickuid")),            2, &AOClient::cmdKickUid}},
        {"firstperson",        {ACLFlags.value(ConfigManager::aclPermission("firstperson")),        0, &AOClient::cmdFirstPerson}},
        {"updateban",          {ACLFlags.value(ConfigManager::aclPermission("updateban")),          3, &AOClient::cmdUpdateBan}},
        {"update_ban",         {ACLFlags.value(ConfigManager::aclPermission("updateban")),          3, &AOClient::cmdUpdateBan}},
        {"changepass",         {ACLFlags.value(ConfigManager::aclPermission("changepass")),         1, &AOClient::cmdChangePassword}},
        {"ignorebglist",       {ACLFlags.value(ConfigManager::aclPermission("ignorebglist")),       0, &AOClient::cmdIgnoreBgList}},
        {"ignore_bglist",      {ACLFlags.value(ConfigManager::aclPermission("ignorebglist")),       0, &AOClient::cmdIgnoreBgList}},
        {"notice",             {ACLFlags.value(ConfigManager::aclPermission("notice")),             1, &AOClient::cmdNotice}},
        {"noticeg",            {ACLFlags.value(ConfigManager::aclPermission("noticeg")),            1, &AOClient::cmdNoticeGlobal}},
        {"togglejukebox",      {ACLFlags.value(ConfigManager::aclPermission("togglejukebox")),      0, &AOClient::cmdToggleJukebox}},
        {"help",               {ACLFlags.value(ConfigManager::aclPermission("help")),               1, &AOClient::cmdHelp}},
        {"clearcm",            {ACLFlags.value(ConfigManager::aclPermission("clearcm")),            0, &AOClient::cmdClearCM}}
    };
