  ...
  private:
    ...
    */
    ...
    const QMap<QString, CommandInfo> commands {
        ...
        {"area_lock",          {ACLFlags.value(ConfigManager::aclPermission("lock")),               0, &AOClient::cmdLock}},
        {"spectatable",        {ACLFlags.value(ConfigManager::aclPermission("spectatable")),        0, &AOClient::cmdSpectatable}},
        {"area_spectate",      {ACLFlags.value(ConfigManager::aclPermission("spectatable")),        0, &AOClient::cmdSpectatable}},
        {"unlock",             {ACLFlags.value(ConfigManager::aclPermission("unlock")),             0, &AOClient::cmdUnLock}},
        {"area_unlock",        {ACLFlags.value(ConfigManager::aclPermission("unlock")),             0, &AOClient::cmdUnLock}},
        ...
        {"area_kick",          {ACLFlags.value(ConfigManager::aclPermission("areakick")),           1, &AOClient::cmdAreaKick}},
        ...
        {"notecard_clear",     {ACLFlags.value(ConfigManager::aclPermission("notecardclear")),      0, &AOClient::cmdNoteCardClear}},
