...
class AOClient : public QObject
{
  ...
  signals:
     ...
     */
    void logIC(const QString &f_areaName, const QString &f_ipid, const QString &f_oocName,
           const QString &f_id, const QString &f_charName, const QString &f_message);

    /**
     * @brief Signal connected to universal logger. Sends OOC chat usage to the logger.
     */
    void logOOC(const QString &f_areaName, const QString &f_ipid, const QString &f_oocName,
          const QString &f_id, const QString &f_charName, const QString &f_message);
